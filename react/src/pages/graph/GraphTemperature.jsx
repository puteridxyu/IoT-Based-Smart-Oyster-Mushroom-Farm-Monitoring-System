...
import { GaugeTemperature } from '../../componets/gauge/Gauge';
import {Link} from "react-router-dom"

import Sidebar from '../../componets/sidebar/Sidebar';
import Topbar from '../../componets/topbar/Topbar';
import { LineTemperature } from '../../componets/realtimeData/ApexChart';
      ...
      <div className="container2">   
        ...
        <div className='userg'>
          <div className = "userTitleContainerg">
            ...
            <button className='userAddButtong temp'>Temperature</button></Link>
            <p>&nbsp;</p>
          ...
          <div className='userUpdateg'><LineTemperature/></div>
          <div className='userShowg'><GaugeTemperature/></div>
