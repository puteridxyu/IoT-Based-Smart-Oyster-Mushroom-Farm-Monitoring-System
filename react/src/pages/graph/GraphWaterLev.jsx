...
import { GaugeTemperature, GaugeWaterLevel } from '../../componets/gauge/Gauge';
import {Link} from "react-router-dom"
import Sidebar from '../../componets/sidebar/Sidebar';
import Topbar from '../../componets/topbar/Topbar';
import { LineWaterLevel } from '../../componets/realtimeData/ApexChart';

export default function GraphWaterLev() {
    ...
    <div>
      ...
      <div className="container2">   
        ...
        <div className='userg'>
          ...
          <div className='userUpdateg'><LineWaterLevel/></div>
          <div className='userShowg'><GaugeWaterLevel/></div>
